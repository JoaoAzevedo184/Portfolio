...
export const contacts: ContactChannel[] = [
  { label: "E-mail", value: "seu-email@exemplo.com", href: "mailto:seu-email@exemplo.com", icon: `${SIMPLE}/gmail` },
  { label: "LinkedIn", value: "/in/seu-perfil", href: "https://www.linkedin.com/in/seu-perfil", icon: `${DEVICON}/linkedin/linkedin-plain.svg`, monoIcon: `${DEVICON}/linkedin/linkedin-plain.svg` },
  { label: "GitHub", value: "JoaoAzevedo184", href: GH, icon: `${DEVICON}/github/github-original.svg` },
  { label: "WhatsApp", value: "(81) 90000-0000", href: "https://wa.me/5581900000000", icon: `${SIMPLE}/whatsapp` },
];
