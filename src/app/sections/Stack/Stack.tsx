            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  style={{
                    width: 52, height: 52,
                    background: isHovered ? `${activeCat.color}12` : `${activeCat.color}08`,
                    border: `1px solid ${isHovered ? `${activeCat.color}33` : `${activeCat.color}15`}`,
                ...
                >
                  <img 
                    ...
                    style={{ 
                      filter: isHovered ? `drop-shadow(0 0 5px ${activeCat.color}88)` : "grayscale(0.2)",
